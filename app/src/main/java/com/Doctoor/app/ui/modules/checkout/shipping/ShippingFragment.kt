...
class ShippingFragment : BaseViewModelFragment<FragmentShippingBinding, ShippingFragmentVM>(),
    ...
    override fun onValidationSuccess() {
        toast("ShippingFragment validated")
    }

    override fun layoutRes() = R.layout.fragment_shipping
    ...
    @Inject
    @ViewModelInjection
    lateinit var viewModel: ViewModelInjectionField<ShippingFragmentVM>
    ...
    override fun getBindingVariable() = BR.shippingFragmentVM
}