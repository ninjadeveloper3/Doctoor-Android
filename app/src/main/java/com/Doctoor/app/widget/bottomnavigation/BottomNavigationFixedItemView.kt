...
internal class BottomNavigationFixedItemView(
    ...
    init {
        ...
        this.paddingHorizontal =
            res.getDimensionPixelSize(R.dimen.bbn_fixed_item_padding_horizontal)
...
//        this.iconTranslation = (if (expanded) 0 else paddingTopInactive - paddingTopActive).toFloat()
        ...
        this.textPaint.typeface = TypefaceUtil.getTypeface(TypefacesFont.MARK_PRO_BOLD)
    }
