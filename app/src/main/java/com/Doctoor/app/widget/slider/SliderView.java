package com.Doctoor.app.widget.slider;
...
import com.Doctoor.app.widget.slider.IndicatorView.PageIndicatorView;
import com.Doctoor.app.widget.slider.IndicatorView.animation.type.AnimationType;
import com.Doctoor.app.widget.slider.IndicatorView.animation.type.BaseAnimation;
import com.Doctoor.app.widget.slider.IndicatorView.animation.type.ColorAnimation;
import com.Doctoor.app.widget.slider.IndicatorView.draw.controller.DrawController;
import com.Doctoor.app.widget.slider.IndicatorView.draw.data.Orientation;
import com.Doctoor.app.widget.slider.IndicatorView.draw.data.RtlMode;
import com.Doctoor.app.widget.slider.IndicatorView.utils.DensityUtils;
import com.Doctoor.app.widget.slider.Transformations.AntiClockSpinTransformation;
import com.Doctoor.app.widget.slider.Transformations.Clock_SpinTransformation;
import com.Doctoor.app.widget.slider.Transformations.CubeInDepthTransformation;
import com.Doctoor.app.widget.slider.Transformations.CubeInRotationTransformation;
import com.Doctoor.app.widget.slider.Transformations.CubeInScalingTransformation;
import com.Doctoor.app.widget.slider.Transformations.CubeOutDepthTransformation;
import com.Doctoor.app.widget.slider.Transformations.CubeOutRotationTransformation;
import com.Doctoor.app.widget.slider.Transformations.CubeOutScalingTransformation;
import com.Doctoor.app.widget.slider.Transformations.DepthTransformation;
import com.Doctoor.app.widget.slider.Transformations.FadeTransformation;
import com.Doctoor.app.widget.slider.Transformations.FanTransformation;
import com.Doctoor.app.widget.slider.Transformations.FidgetSpinTransformation;
import com.Doctoor.app.widget.slider.Transformations.GateTransformation;
import com.Doctoor.app.widget.slider.Transformations.HingeTransformation;
import com.Doctoor.app.widget.slider.Transformations.HorizontalFlipTransformation;
import com.Doctoor.app.widget.slider.Transformations.PopTransformation;
import com.Doctoor.app.widget.slider.Transformations.SimpleTransformation;
import com.Doctoor.app.widget.slider.Transformations.SpinnerTransformation;
import com.Doctoor.app.widget.slider.Transformations.TossTransformation;
import com.Doctoor.app.widget.slider.Transformations.VerticalFlipTransformation;
import com.Doctoor.app.widget.slider.Transformations.VerticalShutTransformation;
import com.Doctoor.app.widget.slider.Transformations.ZoomOutTransformation;

import static com.Doctoor.app.widget.slider.IndicatorView.draw.controller.AttributeController.getRtlMode;
