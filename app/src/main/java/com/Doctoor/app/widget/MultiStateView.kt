...
@JvmOverloads constructor(
    ...
    /**
     * Returns the [View] associated with the [com.Doctoor.app.widget.MultiStateView.ViewState]
     *
     * @param state The [com.Doctoor.app.widget.MultiStateView.ViewState] with to return the view for
     * @return The [View] associated with the [com.Doctoor.app.widget.MultiStateView.ViewState], null if no view is present
     */
    @Nullable
     ...
     * @param state         The [com.Doctoor.app.widget.MultiStateView.ViewState]to set
     * @param switchToState If the [com.Doctoor.app.widget.MultiStateView.ViewState] should be switched to
     */
    ...
    /**
     * Sets the [View] for the given [com.Doctoor.app.widget.MultiStateView.ViewState]
     *
    ...
    /**
     * Shows the [View] based on the [com.Doctoor.app.widget.MultiStateView.ViewState]
     */
