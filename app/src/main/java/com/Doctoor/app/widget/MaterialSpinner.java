...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        typeface = TypefaceUtil.getTypeface(context, TypefacesFont.MARK_PRO_LIGHT);
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        typeface = TypefaceUtil.getTypeface(context, TypefacesFont.MARK_PRO_LIGHT);
        Typeface boldTypeface = TypefaceUtil.getTypeface(context, TypefacesFont.MARK_PRO_BOLD);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawSelector(canvas, getWidth() - 30, getPaddingTop() + dpToPx(8));
