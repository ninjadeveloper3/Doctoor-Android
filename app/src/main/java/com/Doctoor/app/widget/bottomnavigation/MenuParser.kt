...
class MenuParser {
    ...
    private fun readMenu(context: Context, attrs: AttributeSet) {
        ...
        menu?.let {
            ...
            it.forceFixed =
                a.getBoolean(R.styleable.BottomNavigationMenu_bbn_alwaysShowLabels, false)
        }
        a.recycle()
    }
    ...
    fun readItem(mContext: Context, attrs: AttributeSet) {
        ...
        item?.let {
            ...
            it.isItemEnabled =
                a.getBoolean(R.styleable.BottomNavigationMenuItem_android_enabled, true)
                            ...
                            if (lookingForEndOfUnknownTag && tagName == unknownTagName) {
                                ...
                                if (menuParser.hasItem()) {
                                    ...
                                    val tab = BottomNavigationItem(
                                        item!!.itemId, item.itemIconResId,
