...
class CustomEditText : EditTextRichDrawable {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        isClearIconVisible =
            a.getBoolean(R.styleable.CustomEditText_libIZO_setClearIconVisible, false)
        val isBorderView = a.getBoolean(R.styleable.CustomEditText_libIZO_setBorderView, false)
        val mNormalColor =
            a.getColor(R.styleable.CustomEditText_libIZO_setBorderColor, DEFAULTCOLOR)
        val cursorColor = a.getColor(R.styleable.CustomEditText_libIZO_setCursorColor, 0)
        mBackgroundColor =
            a.getColor(R.styleable.CustomEditText_libIZO_setBackgroundColor, Color.TRANSPARENT)
        mStrokeWidth =
            a.getDimension(R.styleable.CustomEditText_libIZO_setStrokeWidth, mStrokeWidth)
        hideShowIconTint =
            a.getColor(R.styleable.CustomEditText_libIZO_hideShowPasswordIconTint, DEFAULTCOLOR)
